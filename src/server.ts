...
class BusinessConsultantServer {
  ...
  private generateSWOTAnalysis(businessName: string, industry: string, businessType?: string, targetMarket?: string, location?: string): string {
    const strengths = [
...
`;
  ...
  private generatePESTAnalysis(businessName: string, industry: string, location?: string, targetMarket?: string): string {
    const political = [
...
`;
  ...
  private calculateFinancialProjections(data: any): string {
...
`;
  ...
  private generateMarketResearch(data: any): string {
...
`;
  ...
  private generateInnovationSuggestions(data: any): string {
...
`;
  ...
  private generateSupplyChainAnalysis(data: any): string {
